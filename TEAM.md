...
- each feature goes into its own branch
- PR required with at least 1 reviewer
- merges done via GitHub UI
...
- Dev branch
  For feature testing
- Feature branch
  For feature development purposes. When creating a feature branch, check out from main branch.
